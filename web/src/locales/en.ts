...
[Insert text here]`,
    ...
    paperSearch: {
      ...
      noHistory: 'No survey history yet.',
      statusPending: 'Pending',
      statusProcessing: 'Processing',
      statusCompleted: 'Completed',
      statusFailed: 'Failed',
      statusCancelled: 'Cancelled',
      getHistoryFailed: 'Failed to fetch survey history',
      keywordEnCategory: 'Keywords (English)',
      keywordCnCategory: '关键词（中文）',
      searchQueryEnCategory: 'Search queries (English)',
      searchQueryCnCategory: 'Search queries (Chinese)',
      exportFileNamePrefix: 'literature_survey',
      keywordsExtracted: 'Keywords extracted. Please select relevant keywords',
      foundPapers: 'Found {{count}} papers using selected keywords',
      pleaseSelectAtLeastOnePaper: 'Please select at least one paper',
      searchRecordNotFound: 'Search record ID not found',
      surveySubmitted:
        'Survey generation task submitted. Selected {{count}} papers',
