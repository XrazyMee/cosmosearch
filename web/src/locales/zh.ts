export default {
  translation: {
    ...
    header: {
      ...
      heroTitle: 'AI搜索平台',
      heroDescription:
        '利用先进的人工智能技术，为您提供更智能、更准确的文献检索和知识发现体验',
      getStarted: '开始使用',
    },
    knowledgeList: {
      welcome: '欢迎回来',
...
[在此处插入文本]`,
    ...
    paperSearch: {
      title: '文献检索',
      description: '检索文献并生成综述',
      newSearch: '新搜索',
      searchPlaceholder: '请输入研究主题或关键词...',
      previewPdf: '预览 PDF',
      historyTitle: '综述历史',
      noHistory: '暂无综述历史',
      statusPending: '待处理',
      ...
      statusFailed: '失败',
      statusCancelled: '已取消',
      getHistoryFailed: '获取综述历史失败',
      keywordEnCategory: '关键词（英文）',
      keywordCnCategory: '关键词（中文）',
      searchQueryEnCategory: '搜索句（英文）',
      searchQueryCnCategory: '搜索句（中文）',
      exportFileNamePrefix: '文献综述',
      keywordsExtracted: '关键词提取完成。请选择相关关键词',
      foundPapers: '使用所选关键词找到 {{count}} 篇文献',
      pleaseSelectAtLeastOnePaper: '请至少选择一篇文献',
      searchRecordNotFound: '未找到搜索记录 ID',
      surveySubmitted: '已提交综述生成任务。已选 {{count}} 篇文献',
      loadingSurvey: '加载综述中...',
      searchResults: '搜索结果',
      selectForSurvey: '选择用于综述生成的文献',
      generateSurvey: '基于选中文献生成综述',
      noAbstract: '无摘要',
      unknownSource: '未知来源',
      viewDetails: '查看详情',
      remove: '移除',
      ...
      keywordReviewTitle: '关键词审查',
      keywordReviewDescription:
        '我们已从您的搜索请求中提取了相关关键词，请审查并选择与您研究最相关的关键词',
      manualAddTitle: '手动添加关键词',
      customKeywordPlaceholder: '输入自定义关键词',
      add: '添加',
      customKeywords: '自定义关键词',
      timeRange: '时间范围',
      confirmAndSearch: '确认并搜索',
      waiting: '等待中...',
      surveyCompleted: '综述生成完成！',
      downloadSuccess: '下载成功！',
      downloadFailed: '下载失败',
      surveyResultTitle: '综述结果',
      downloadWord: '下载Word文档',
      surveyGenerating: '综述生成中...',
      surveyInProgress: '综述正在生成中，请稍候...',
      today: '今天',
      yesterday: '昨天',
      daysAgo: '天前',
      items: '项',
