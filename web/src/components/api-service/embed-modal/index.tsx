  ...
  return (
    ...
    >
      ...
      <Link
        href={
          isAgent
            ? 'https://cosmosearch.io/docs/dev/http_api_reference#create-session-with-agent'
            : 'https://cosmosearch.io/docs/dev/http_api_reference#create-session-with-chat-assistant'
        }
        target="_blank"
      >
